#! /usr/bin/env bash
#########################################################################
# File Name: wordprocess.sh
# Author:陈俊杰
# mail: 2716705056@qq.com
# Created Time: 2021年09月25日 星期六 11时11分39秒

# 此程序的功能是：
#########################################################################

# 搞定 Linux Shell 文本处理工具，看完这篇就够了
# https://mp.weixin.qq.com/s?__biz=MjM5NDEwNzc0MQ==&mid=2650952389&idx=1&sn=1fe5f0599fb4cc8308593b3a92588cac&chksm=bd7a2af78a0da3e12939b4fe783d3e25606aa2b69a6a8ca5e4dcd4262427fc7ec3ee0975b077&mpshare=1&scene=24&srcid=0914MRmr8D1zxS2zdtvdFx4N&sharer_sharetime=1631579707470&sharer_shareid=0d5c82ce3c8b7c8f30cc9a686416d4a8&exportkey=ARTknB37qffPcT85Iug1TPc%3D&pass_ticket=Hg2k1XuNzrrHf4g7vxT6ejZKBJTO3tA6NkozXyuJX%2BBQt1ShC0tBmk%2FKkzo01lbK&wx_header=0#rd
...
# awk常用内建函数
# index(string,search_string):返回search_string在string中出现的位置sub(regex,replacement_str,string):将正则匹配到的第一处内容替换为replacement_str;
